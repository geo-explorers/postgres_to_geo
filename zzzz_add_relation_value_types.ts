...
const ops: Array<Op> = [];
let addOps;
const cryptoSpaceId = "3f32353d-3b27-4a13-b71a-746f06e1f7db"
const rootSpaceId = "29c97d29-1c9a-41f1-a466-8a713764bc27"
const educationSpaceId = "0fcbc499-71e5-4505-a081-aa26edd97937"
const regionsSpaceId = "aea9f05a-2797-4e7e-aeae-5059ada3b56b"
...
//Education relations
const educationRelations: RelationMapping[] = [
  {
    from: "7ec4a220-45a9-4f45-b134-c3b38ae17a6f",
    to: ["2f37e21a-4254-47e1-ad9f-8e362ded9193"], // Quarter
  }
]

//Regions relations
const regionsRelations: RelationMapping[] = [
  {
    from: "2c7e5442-67ad-48a3-a714-6872c94b23b4",
    to: ["7ed45f2b-c48b-419e-8e46-64d5ff680b0d"], // Person
  }
]

//Crypto relations
const cryptoRelations: RelationMapping[] = [
  {
    from: "92770756-3573-4c29-be10-4e3e6d7556b5",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // project
  },
  {
    from: "b4878d1a-0609-488d-b8a6-e19862d6b62f",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // project
  },
  {
    from: "117bb4dd-fdbe-43ec-bf28-9826031aa64a",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // project
  },
  {
    from: "9b8a610a-fa35-486e-a479-e253dbdabb4f",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // project
  },
  {
    from: "429dfd6b-1fe4-411b-8aca-1c10e7779e98",
    to: [
      "7ed45f2b-c48b-419e-8e46-64d5ff680b0d", // Person
      "484a18c5-030a-499c-b0f2-ef588ff16d50", // Project
    ],
  },
  {
    from: "4932a5cc-f0f6-451c-affe-90de2c90b2e2",
    to: ["8f03f4c9-59e4-44a8-a625-c0a40b1ff330"], // Funding round type
  },
  {
    from: "79e0543e-865f-4163-887d-a27a8be9af18",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // Project
  },
  {
    from: "7bcf57f8-ae1d-43d2-a47e-de60be950f0e",
    to: ["cbccb349-1e90-49c3-8d1d-e58e1a00a81c"], // Technology type
  },
  {
    from: "808261d4-4993-472e-890a-317c2c2dcfad",
    to: ["7ed45f2b-c48b-419e-8e46-64d5ff680b0d"], // Person
  },
  {
    from: "8afc80a2-ac8f-4d3b-b6bc-f2f41539e7df",
    to: ["f8780a80-c238-4a2a-96cb-567d88b1aa63"], // Asset
  },
  {
    from: "943480c3-4374-494e-baab-913ce6d0cb5b",
    to: ["fca08431-1aa1-40f2-8a4d-0743c2a59df7"], // Network type
  },
  {
    from: "c59a54ef-56e8-43b5-b523-df967b65771b",
    to: ["fca08431-1aa1-40f2-8a4d-0743c2a59df7"], // Network type
  },
  {
    from: "c7f59f27-2eb6-4cce-9bff-431f6f4b73c3",
    to: ["8f03f4c9-59e4-44a8-a625-c0a40b1ff330"], // Funding round
  },
  {
    from: "e188254b-785d-48ac-a846-1d0eb09c98f5",
    to: ["fd251b40-89d3-4945-b648-647ce51ef852"], // Asset categories
  },
  {
    from: "e278c3d4-78b9-4222-b272-5a39a8556bd2",
    to: ["8d35d217-3fa1-4686-b74f-fcb3e9438067"], // Funding stage type
  },
  {
    from: "156dfd37-1636-4569-9115-9267b8ca2f1e",
    to: ["d4c7a271-7ab9-435e-aff3-62b0f33d0ccb"], // Pricing model type
  },
];

const rootRelations: RelationMapping[] = [
  {
    from: "49c5d5e1-679a-4dbd-bfd3-3f618f227c94",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // Project
  },
  {
    from: "11b06581-20d3-41ea-b570-2ef4ee0a4ffd",
    to: ["9291e563-afbe-4709-8780-a52cbb0f4aa9"], // Currency
  },
  {
    from: "14611456-b466-4cab-920d-2245f59ce828",
    to: ["5338cc28-9704-4e96-b547-7dfc58da6fc7"], // Renderable type
  },
  {
    from: "1c5b7c0a-d187-425e-885c-2980d9db6b4b",
    to: ["3317d044-a700-4a9d-bbaf-4c16ade42f76"], // Continent type
  },
  {
    from: "6d8cd471-f7af-415f-9411-18b1ef106434",
    to: ["42a0a761-8c82-459f-ad08-34bfeb437cde"], // Country type
  },
  {
    from: "34f53507-2e6b-42c5-a844-43981a77cfa2",
    to: ["ba4e4146-0010-499d-a0a3-caaa7f579d0e"], // Image type
  },
  {
    from: "6c49012e-21fd-4b35-b976-60210ea0ae0f",
    to: ["ba4e4146-0010-499d-a0a3-caaa7f579d0e"], // Image type
  },
  {
    from: "39e40cad-b23d-4f63-ab2f-aea1596436c7",
    to: ["5ef5a586-0f27-4d8e-8f6c-59ae5b3e89e2"], // Topic type
  },
  {
    from: "458fbc07-0dbf-4c92-8f57-16f3fdde7c32",
    to: ["5ef5a586-0f27-4d8e-8f6c-59ae5b3e89e2"], // Topic type
  },
  {
    from: "b35bd6d3-9fb6-4f3a-8aea-f5a9b91b5ef6",
    to: ["5ef5a586-0f27-4d8e-8f6c-59ae5b3e89e2"], // Topic type
  },
  {
    from: "47b55f87-c5ca-4b2d-b1ac-32296fd0c650",
    to: ["3df12375-8de0-4f32-8e93-b0aee1d04324"], // State type
  },
  {
    from: "4d9cba1c-4766-4698-81cd-3273891a018b",
    to: ["480e3fc2-67f3-4993-85fb-acdf4ddeaa6b"], // Page type
  },
  {
    from: "6d29d578-49bb-4959-baf7-2cc696b1671a",
    to: ["a35e058b-52d1-48d2-b02d-773933d90b7e"], // Native type
  },
  {
    from: "72ba2a0f-729d-4847-925d-f3b09d46bb66",
    to: ["5c6e72fb-8340-47c0-8281-8be159ecd495"], // Address type
  },
  {
    from: "73609ae8-644c-4463-a50a-90a3ee585746",
    to: ["96f859ef-a1ca-4b22-9372-c86ad58b694b"], // Claim type
  },
  {
    from: "81891dec-cb6c-427e-aa1f-b917292ec2dc",
    to: ["362c1dbd-dc64-44bb-a3c4-652f38a642d7"], // Space type
  },
  {
    from: "9678296f-ca60-4e17-a997-a5dbbc227d18",
    to: ["4318a1d2-c441-455c-b765-44049c45e6cf"], // Question type
  },
  {
    from: "a945fa95-d15e-42bc-b70a-43d3933048dd",
    to: ["fca08431-1aa1-40f2-8a4d-0743c2a59df7"], // Network type
  },
  {
    from: "beaba5cb-a677-41a8-b353-77030613fc70",
    to: [
      "b8803a86-65de-412b-bb35-7e0c84adf473", // Data block
      "76474f2f-0089-4e77-a041-0b39fb17d0bf", // Text block
    ],
  },
  {
    from: "c9ed4b4b-7294-4eda-9a03-a7975cd1651e",
    to: [
      "7ed45f2b-c48b-419e-8e46-64d5ff680b0d", // Person
      "484a18c5-030a-499c-b0f2-ef588ff16d50", // Project
    ],
  ...
  {
    from: "e3a96728-2b09-4af7-9af7-86ef1aa7837e",
    to: ["484a18c5-030a-499c-b0f2-ef588ff16d50"], // Project
  },
  {
    from: "e4047a77-0043-4ed4-a410-72139bff7f7e",
    to: ["cb69723f-7456-471a-a8ad-3e93ddc3edfe"], // Account type
  },
  {
    from: "eb1141ae-ba35-43df-acdd-3329cccd8121",
    to: ["7ed45f2b-c48b-419e-8e46-64d5ff680b0d"], // Person type
  },
  {
    from: "ec39a534-e7c8-4923-90dc-c3d80e76bf46",
    to: ["fc512a40-8b55-44dc-85b8-5aae88b51fae"], // Industry
  },
  {
    from: "f9eeaf9d-9eb7-41b1-ac5d-257c6e82e526",
    to: ["043a171c-6918-4dc3-a7db-b8471ca6fcc2"], // Quote type
  },
  {
    from: "fa8fbad0-101c-4020-8d9b-dde11a381bdb",
    to: ["949c984f-518c-483d-b44d-1c3dbd920f8a"], // County type
  },
  {
    from: "4e6ec5d1-4292-498a-84e5-f607ca1a08ce",
    to: ["96f859ef-a1ca-4b22-9372-c86ad58b694b"], // Claim type
  },
  {
    from: "1dc6a843-4588-4819-8e7a-6e672268f811",
    to: ["96f859ef-a1ca-4b22-9372-c86ad58b694b"], // Claim type
  },
  {
    from: "1907fd1c-8111-4a3c-a378-b1f353425b65",
    to: ["20a21dc2-7371-482f-a120-7b147f1dc319"], // View
  },
];
...
cryptoRelations.forEach(({ from, to }) => {
  to.forEach((toEntity) => {
...
await publishOps(await addSpace(ops, cryptoSpaceId))
